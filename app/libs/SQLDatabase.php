...
// put this under constructor
$db_conf = get_config('database')['oracle'];
$connectionString = "  
(DESCRIPTION =
    (ADDRESS_LIST =
      (ADDRESS = (PROTOCOL = TCP)(HOST = ".$db_conf['host'].")(PORT = ".$db_conf['port']."))
    )
    (CONNECT_DATA =
...
define("DB_PASS", $db_conf['password']);
define("DB_CONN_STRING", $connectionString);

/*
 * To change this template, choose Tools | Templates
 * and open the template in the editor.
 * https://github.com/ogres/PHP-Oracle-SQLDatabase
 */
